...
/***/ "./src/elements/task-element.js":
/*!**************************************!*\
  !*** ./src/elements/task-element.js ***!
  \**************************************/
/*! exports provided: TaskElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"TaskElement\", function() { return TaskElement; });\n/* harmony import */ var _view_elements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view-elements.js */ \"./src/elements/view-elements.js\");\n/* harmony import */ var _controllers_taskController_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/taskController.js */ \"./src/controllers/taskController.js\");\n\n\n\n\nconst TaskElement = (() => {\n\n\n  let taskId;\n\n  const newTask = (formFields) => {\n\n    taskId = \"task\"+generateTaskId();\n\n    let task = _controllers_taskController_js__WEBPACK_IMPORTED_MODULE_1__[\"TaskController\"].createTask(formFields.title, formFields.description,\n                                         formFields.dueDate, formFields.priority);\n\n    _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addChildrenTo(\n      _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\"#tasks\"),[createTaskItem(task)]\n    );\n\n    attachShowDetailsTo(_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\"#\"+taskId).querySelector(\"a\"));\n\n    return task;\n  }\n\n  const createTaskItem = (task) => {\n\n    return _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addChildrenTo(\n             _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addAttributes(\n               _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"li\"), {\"id\": taskId}),\n             [createTitleElement(task), createTaskDetails(task)]\n           );\n  }\n\n  const createTitleElement = (task) => {\n    return _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addChildrenTo(\n             _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(\n               _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"div\"),[\"task-title\"]\n             ),[_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"h2\",task.getName()),\n                createShowTaskDetails()]\n           );\n  }\n\n  const createShowTaskDetails = () => {\n\n    return _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(\n             _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addAttributes(\n               _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"a\",\"Show details\"),{\"href\":\"#\"}\n             ),[\"bt-details\"]\n           );\n  }\n\n  const createTaskDetails = (task) => {\n\n    return _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].applyStyles(\n            _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(\n              _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"div\"),[\"task-details\"]\n            ), {\"display:\":\"none\"}\n          )\n  }\n\n  const attachShowDetailsTo = (button) => {\n\n    let taskDetailsElement = _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\"#\"+taskId).children[1];\n\n    _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].attachEvent(button,\"click\", e => {\n      if (taskDetailsElement.style.display == \"none\") {\n        taskDetailsElement.style.display = \"flex\";\n        button.textContent = \"Hide details\";\n      } else {\n        taskDetailsElement.style.display = \"none\";\n        button.textContent = \"Show details\";\n      }\n    });\n  }\n\n  const generateTaskId = () => {\n    return _view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\"#tasks\").children.length + 1;\n  }\n\n  return { newTask }\n\n})();\n\n\n\n\n//# sourceURL=webpack:///./src/elements/task-element.js?");
