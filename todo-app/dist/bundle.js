...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"App\", function() { return App; });\n/* harmony import */ var _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/view-elements.js */ \"./src/view-elements.js\");\n\n\nconst App = (() => {\n\n  const createTodo = (name, todoItemView, todoItemContainer) => {\n    let todoItem      = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(todoItemView);\n    let spanTodoName  = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"span\");\n    let spanDel       = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"span\");\n    let todosList     = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(todoItemContainer);\n    let todoId        = generateTodoId(todosList);\n\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].setContent(spanTodoName,name);\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].setContent(spanDel, \"x\");\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(spanDel,[\"bt-remove\"]);\n\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addAttributes(todoItem, {\"id\": todoId});\n    todoItem.appendChild(spanTodoName);\n    todoItem.appendChild(spanDel);\n\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].attachEvent(todoItem, \"click\", e => {\n      if (e.target.tagName === \"LI\" || e.target.textContent != \"x\") {\n        let todoHeader   = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\".todo-title\");\n        let todoActions  = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"div\");\n        let todoTitle    = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"h1\");\n        let removeTodo   = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"div\");\n        let btAddTask    = _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].newElement(\"div\");\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].applyStyles(todoHeader, {\"display:\":\"flex\"});\n\n        todoTitle.textContent = name;\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(btAddTask,[\"add-task\"]);\n        btAddTask.textContent = \"Add Task\";\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(removeTodo, [\"bt-remove\"]);\n        removeTodo.textContent = \"Remove\";\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].attachEvent(removeTodo, \"click\", e => {\n          while (todoHeader.hasChildNodes()) {\n            todoHeader.removeChild(todoHeader.lastChild);\n          }\n          _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].applyStyles(todoHeader, {\"display:\":\"none\"});\n        })\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].addClass(todoActions,[\"todo-actions\"]);\n        todoActions.appendChild(todoTitle);\n        todoActions.appendChild(removeTodo);\n\n        todoHeader.appendChild(todoActions);\n        todoHeader.appendChild(btAddTask);\n\n        _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].getElement(\".todo-container\").appendChild(todoHeader);\n      }\n    });\n\n    _src_view_elements_js__WEBPACK_IMPORTED_MODULE_0__[\"ViewElements\"].attachEvent(spanDel, \"click\", e => {\n      todosList.removeChild(todoItem);\n    });\n\n    todosList.appendChild(todoItem);\n  }\n\n  const generateTodoId = (todosList) => {\n    return todosList.children.length + 1;\n  }\n\n\n\n  return { createTodo }\n\n})();\n\n\n\n\n//# sourceURL=webpack:///./src/app-todo.js?");
