...
/***/ "./src/views/appViewManager.js":
/*!*************************************!*\
  !*** ./src/views/appViewManager.js ***!
  \*************************************/
/*! exports provided: ManagerView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ManagerView\", function() { return ManagerView; });\n/* harmony import */ var _views_itemList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../views/itemList.js */ \"./src/views/itemList.js\");\n\n\nconst ManagerView = (() => {\n\n  let todosList;\n\n  const addNewTodoToListOfTodos = (todoName) => {\n    todosList = document.querySelector(\".lst-todos\");\n    todosList.appendChild(_views_itemList_js__WEBPACK_IMPORTED_MODULE_0__[\"ItemList\"].newListItem(todoName, nextItemListId()));\n  }\n\n  const nextItemListId = () => {\n    return (todosList.children.length + 1);\n  }\n\n  return { addNewTodoToListOfTodos }\n\n})()\n\n\n\n\n//# sourceURL=webpack:///./src/views/appViewManager.js?");
